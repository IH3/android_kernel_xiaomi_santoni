...
static void mdss_mdp_kcal_update_pcc(struct kcal_lut_data *lut_data)
{
	...
	pcc_config.ops = 1 ? MDP_PP_OPS_WRITE | MDP_PP_OPS_ENABLE :
...
static void mdss_mdp_kcal_update_pa(struct kcal_lut_data *lut_data)
{
	...
	if (mdata->mdp_rev < MDSS_MDP_HW_REV_103) {
		...
		pa_config.pa_data.flags = 1 ? MDP_PP_OPS_WRITE | MDP_PP_OPS_ENABLE :
				MDP_PP_OPS_WRITE | MDP_PP_OPS_DISABLE;
		...
		pa_v2_config.pa_v2_data.flags = 1 ? MDP_PP_OPS_WRITE | MDP_PP_OPS_ENABLE :
				MDP_PP_OPS_WRITE | MDP_PP_OPS_DISABLE;
